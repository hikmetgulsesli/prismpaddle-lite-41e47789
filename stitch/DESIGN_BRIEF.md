...
- PrismPaddle Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called PrismPaddle Lite. It should be a full-viewport paddle-and-orb arcade game where the player moves a paddle with keyboard and mouse/touch, bounces an orb through colored prism blocks, collects score multipliers, pauses/resumes, opens settings/help, adjusts difficulty/audio,…
...
- Gameplay - PrismPaddle Lite
- Game Settings - PrismPaddle Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - PrismPaddle Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - PrismPaddle Lite
